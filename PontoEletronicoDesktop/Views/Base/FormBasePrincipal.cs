using PontoEletronicoDesktop.Views.Inicio;
...
{
    public partial class FormBasePrincipal : Form
    {
        #region Variaveis
        ...
        private void InicializaInicio()
        {
            ...
            var form = new FormInicio("Início");
        ...
        private void InicializaAtualizaCadastro()
        {
            ...
            //var form = new FormAtualizarCadastroConsulta("Atualizar Cadastros");
            //form.Dock = DockStyle.Fill;
            //form.TopLevel = false;
            //form.Visible = true;
